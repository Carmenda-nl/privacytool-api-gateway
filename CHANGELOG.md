...
## [2.1.5-beta] - 2026-09-04

### Changed

- Exclude datakey from zip

### Fixed

- Readme clearance correction
...
- Allow blank engine selection in settings
- Update packages
...
- Simplyfied make & github release

## [2.1.2] - 2026-08-06

### Fixed

- Frozen build still reports stale/-beta version

## [2.1.1] - 2026-08-04

### Changed

- Remove dublicate from changelog
...
- Consent file disappears after engine run
- Ruff format & double run on workflow
